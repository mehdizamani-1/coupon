    ...
    <div class="content-wrapper">
        ...
        <div class="card card-shadow h-100">
            <div class="card-header border-0">
                <h2 class="h6 py-3 mb-0 font-weight-bold card-title">پیام ها</h2>
            </div>
            <div class="card-body">
            ...
            <!-- change 6/9/98 -->
                ...
                <div class="table-responsive">
                    <table id="data_table" class="table table-bordered table-striped table2excel border" cellspacing="0">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>نام ادمین</th>
                            ...
                            @foreach( $messages as $item )
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if( $item['type'] == 0  && $item['reply'] == '' )
                                            <button type="button" class="btn btn-primary reply" data-toggle="modal"
                                                    data-id="{{ $item['id'] }}">جواب
                                            </button>
                                        @elseif( $item['type'] == 0  && $item['reply'] != '' )
                                            <span class="fa fa-check"></span>
                                        @elseif( $item['type'] == 1   )
                                            -
                                        @endif
                                    </td>
                                    <td>{{ gregorian_to_jalali_pro($item['created_at'], true) }}</td>

                                    <td class="text-center">
                                        @if($item['type'] == 0)
                                            <a class="btn btn-primary fa fa-eye"
                                               href=""></a>
                                        @endif
                                    </td>
                                </tr>
